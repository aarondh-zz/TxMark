...
{
    public class TxMarkTagger : ITagger<TextMarkerTag>
    {
        ...
        public TxMarkTagger(ITextView view, ITextBuffer sourceBuffer, 
        ...
        {
            var source = this.SourceBuffer.CurrentSnapshot.GetText();
            ...
            var txMarkSyntaxHighlighterParseTreeWalker = new TxMarkSyntaxHighlighterParseTreeWalker(this.SourceBuffer.CurrentSnapshot);
            try
            {
